...
const ContactPage = () => {
    return (
        <section className="px-4 flex flex-wrap justify-center py-20 overflow-hidden gap-24">
                    ...
                    <div className="mx-auto flex max-w-2xl flex-col gap-10">
                        ...
                        <div className="grid gap-4 md:grid-cols-2">
                            {contact.map((item, index) => {
                                ...
                                return (
                                    <div key={index} className="bg-muted rounded-lg p-4 flex flex-col justify-between gap-12">
                                        <div>
